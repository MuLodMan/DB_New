...
def main():
    ...
    parser.add_argument('--groupLevel',type=int,help='set train gropLevel(The larger level the more data)')
    ...
    experiment = Configurable.construct_class_from_config(experiment_args) #ImageDatasets  init from config file (yaml)
