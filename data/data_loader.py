...
class DataLoader(Configurable, torch.utils.data.DataLoader):
    dataset = State() #data.image_dataset.ImageDataset
    ...
    def __init__(self, **kwargs):
        self.load_all(**kwargs) #for debug experiment.DataLoader 
        ...
        if cmd.get('distributed'):
            ...
            torch.utils.data.DataLoader.__init__(
                ...
                drop_last=self.drop_last, shuffle=self.shuffle, #self.shuffle, #for debug comment this
